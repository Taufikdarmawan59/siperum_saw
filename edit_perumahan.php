          ...
          <div class="col-8">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <div class="col">
                  <h3 class="card-title">Update Data Perumahan</h3>
                </div>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                <form action="<?php echo base_url('admin/update_data/'.$perumahan->id); ?>" method="post" enctype="multipart/form-data" class="row g-3 needs-validation">
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="example-text-input" class="form-control-label">Nama Perumahan:</label>
                        <input class="form-control" type="text" name="nama_perumahan" value="<?php echo $perumahan->nama_perumahan; ?>" required>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                  ...
                  <div class="col-12">
                    <button class="btn btn-primary" type="submit" value="Update">Submit form</button>
                  </div>
                </div>
                </form>
